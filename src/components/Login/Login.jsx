...
export default function Login() {
  ...
  let validationSchema = yup.object().shape({
    ...
    password: yup.string().matches(/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$/, 'Wrong Password.').required('password is required'),
    ...
    <div className='py-6 max-w-xl mx-auto m-20'>
      ...
      <form className="max-w-md mx-auto mt-5" onSubmit={formik.handleSubmit}>
        ...
        <div className='flex items-center '>
          <button type="submit" className="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-700">
